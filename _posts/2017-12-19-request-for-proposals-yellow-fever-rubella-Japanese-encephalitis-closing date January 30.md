...
We ask the applicant groups to ideally use the standardised demographic data available for download through the Consortium delivery platform. **To access the data, the upload templates, and to submit the burden estimates generated by your model, please contact [vimc@imperial.ac.uk](vimc@imperial.ac.uk) to request an account which will enable you to log-in to the delivery platform. _This will be available starting on January 8, 2018._**
...
To have your model considered by the VIMC secretariat, please email the following documents to [vimc@imperial.ac.uk](vimc@imperial.ac.uk) with a subject line **“RfP 2018 – [your disease area] – [your group name]”** by **January 30, 2018 23:00 GMT**:
